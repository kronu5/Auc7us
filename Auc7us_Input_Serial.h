...
#define SERB_PAD_LEFT    0x8000	//dLeft   //   bit7 - Left Button test
#define SERB_PAD_DOWN    0x4000 //dDown   //   bit6 - Down Button test
#define SERB_PAD_RIGHT   0x2000 //dRight  //   bit5 - Right Button test
#define SERB_PAD_UP      0x1000 //dUp     //   bit4 - Up Button test
#define SERB_START       0x800  //start   //   bit3 - Start Button test
#define SERB_R3          0x400  //R3	  //   bit2 - R3 Button test (Horn)
#define SERB_L3          0x200  //L3	  //   bit1 - L3 Button test
#define SERB_SELECT      0x100  //select  //   bit0 - Select Button test

// DualShock(2)
#define SERB_SQUARE      0x80   //square  //   bit7 - Square Button test
#define SERB_CROSS       0x40   //cross   //   bit6 - Cross Button test
#define SERB_CIRCLE      0x20   //circle  //   bit5 - Circle Button test
#define SERB_TRIANGLE    0x10   //triangle//   bit4 - Triangle Button test
#define SERB_R1          0x8    //R1      //   bit3 - R1 Button test
#define SERB_L1          0x4    //L1      //   bit2 - L1 Button test
#define SERB_R2          0x2    //R2      //   bit1 - R2 Button test
#define SERB_L2          0x1    //L2	  //   bit0 - L2 Button test

#define  SER_RX          3		//rX	  // DualShock(3) - Right stick Left/right
#define  SER_RY          4		//rY	  // DualShock(4) - Right Stick Up/Down
#define  SER_LX          5		//lX	  // DualShock(5) - Left Stick Left/right
#define  SER_LY          6		//lY	  // DualShock(6) - Left Stick Up/Down
